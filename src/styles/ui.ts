export const primaryCta =
  'ui-button inline-flex min-h-[56px] w-full items-center justify-center gap-2 px-6 py-4 text-base font-semibold sm:w-auto focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-[var(--text-primary)] disabled:opacity-50 disabled:cursor-not-allowed';
...
export const primaryCtaStrong = `${primaryCta} ui-button-strong`;

export const primaryCtaMono = `${primaryCta} font-mono text-xs uppercase tracking-widest`;
