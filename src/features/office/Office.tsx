    ...
    <main className="flex-grow w-full max-w-[1440px] mx-auto border-x border-[var(--border-subtle)] flex flex-col bg-[var(--bg-base)] backdrop-blur-sm min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-88px)] mt-[64px] md:mt-[88px]">
      <header className="relative p-8 md:p-16 border-b border-[var(--border-subtle)] bg-[var(--bg-base)] overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 relative z-10 pb-8">
          <div>
            <h1 className="font-display text-5xl sm:text-7xl md:text-[10rem] leading-none font-bold tracking-tighter uppercase text-[var(--text-primary)] drop-shadow-md">
              OFFICE
            </h1>
          </div>
      ...
      <footer className="border-t border-[var(--border-subtle)] p-8 flex flex-col sm:flex-row justify-between items-center gap-4 font-mono text-[10px] uppercase text-[var(--text-secondary)] tracking-widest bg-[var(--bg-base)]">
        ...
        <div className="flex gap-8">
          <Link href="/contact" className="hover:text-[var(--text-primary)] transition-colors">Legal</Link>
          <Link href="/contact" className="hover:text-[var(--text-primary)] transition-colors">Privacy</Link>
          <Link href="/office" className="hover:text-[var(--text-primary)] transition-colors">Archive</Link>
        </div>
      </footer>
    </main>
  );
