        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-12 lg:pl-16">
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Frontend</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">React, TypeScript, JavaScript, HTML, CSS, Tailwind</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Backend</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">Node.js, Python, SQL, REST APIs</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Systems</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">C, Bash, Linux (RHEL), Windows</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Debugging</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">gdb, valgrind, strace</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Platforms</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">Shopify, WooCommerce, WordPress</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Cloud</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">AWS, Docker, Vercel</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Tools</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">Git, GitHub Actions, Jira, Confluence, Figma</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              <div className="w-12 h-px bg-[var(--border-strong)] mt-3 md:block hidden relative crosshair"></div>
              <div>
                <h3 className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-widest mb-2 border-b border-[var(--border-subtle)] pb-2 inline-block">Automation</h3>
                <p className="font-display text-2xl md:text-3xl uppercase tracking-wider text-[var(--text-primary)] mt-4">Google Apps Script, API Integration</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="p-8 md:p-16 bg-[var(--bg-base)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.slice(0,3).map((project) => (
            <NavLink key={project.id} to={`/project/${project.id}`} className="group border border-[var(--border-strong)] flex flex-col hover:bg-[var(--hover-bg)] transition-colors p-8 tech-panel relative min-h-[300px] shadow-[0_10px_30px_var(--shadow-base)]">
