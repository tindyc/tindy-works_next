  ...
  return (
    <main className="flex-grow w-full max-w-[1440px] mx-auto border-x border-[var(--border-subtle)] flex flex-col bg-[var(--overlay-bg)] backdrop-blur-md min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-88px)] mt-[64px] md:mt-[88px]">
      ...
      <div className="flex justify-end p-4 md:p-8 border-b border-[var(--border-subtle)] bg-[var(--bg-base)]">
        <button onClick={() => navigate('/office')} className="border border-[var(--border-strong)] p-3 hover:bg-[var(--text-primary)] hover:text-[var(--bg-base)] transition-colors group bg-[var(--bg-base)] focus:outline-none focus:ring-2 focus:ring-white">
      ...
      <header className="p-8 md:p-16 border-b border-[var(--border-subtle)] relative overflow-hidden bg-[var(--bg-base)] tech-panel">
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at 10px 10px, white 1px, transparent 0)', backgroundSize: '20px 20px' }}></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 flex-grow">
        ...
        <section className="lg:col-span-9 p-8 md:p-16 lg:p-24 space-y-24 bg-[var(--bg-base)] relative">
          ...
          <div className="relative pl-8 border-l-2 border-[var(--border-strong)] hover:border-[var(--text-primary)] transition-colors group">
             <div className="absolute top-0 -left-[11px] w-5 h-5 bg-[var(--bg-base)] border border-[var(--border-strong)] group-hover:border-[var(--text-primary)] flex items-center justify-center transition-colors">
             ...
             <div className="w-full max-w-4xl border border-[var(--border-strong)] bg-[var(--hover-bg)] p-8 aspect-auto md:aspect-[2/1] flex flex-col relative overflow-hidden tech-panel mt-16 shadow-2xl floor-plan-grid">
                ...
                <div className="flex-grow flex items-center justify-center w-full relative z-10 py-12">
                  <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 w-full px-4 md:px-12 mt-4">
                     <div className="w-full md:flex-1 border border-[var(--border-strong)] p-6 text-center text-[var(--text-primary)] font-mono text-xs uppercase tracking-widest bg-[var(--bg-base)] backdrop-blur-md relative shadow-[0_4px_15px_var(--shadow-base)]">
                     ...
                     <div className="h-8 w-px md:h-px md:w-16 bg-[var(--border-strong)] relative">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 border border-[var(--border-strong)] bg-[var(--bg-base)]"></div>
                     </div>
                     ...
                     <div className="w-full md:flex-1 border border-[var(--border-strong)] p-6 text-center text-[var(--text-primary)] font-mono text-xs uppercase tracking-widest bg-[var(--bg-base)] backdrop-blur-md shadow-[0_4px_15px_var(--shadow-base)]">
                        Client DB
                     </div>
                  </div>
                </div>
