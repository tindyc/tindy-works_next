  ...
  return (
    <aside className="order-2 lg:order-none w-full lg:w-[360px] xl:w-[420px] shrink-0 border-t lg:border-t-0 lg:border-l border-[var(--border-subtle)] bg-[var(--bg-base)] p-4 md:p-6 lg:p-8 flex flex-col z-30">
      ...
      <div className="mt-6 lg:mt-12 flex flex-col gap-4 border border-[var(--border-subtle)] p-4 md:p-6 bg-[var(--hover-bg)] font-mono">
        <div className="flex justify-between items-center border-b border-[var(--border-subtle)] pb-2 flex-wrap gap-2">
            <span className="text-[10px] uppercase tracking-widest text-[var(--text-secondary)]">SYSTEM_STATUS</span>
            <span className="text-xs text-[var(--text-primary)] text-right">ONLINE</span>
        </div>
        <div className="flex justify-between items-center border-b border-[var(--border-subtle)] pb-2 flex-wrap gap-2">
            <span className="text-[10px] uppercase tracking-widest text-[var(--text-secondary)]">ACTIVE_ZONES</span>
            <span className="text-xs text-[var(--text-primary)] text-right">3</span>
        </div>
        <div className="flex justify-between items-center flex-wrap gap-2">
            <span className="text-[10px] uppercase tracking-widest text-[var(--text-secondary)]">ATMOSPHERE</span>
            <span className="text-xs text-[var(--text-primary)] text-right">CONTROLLED</span>
        </div>
      </div>
