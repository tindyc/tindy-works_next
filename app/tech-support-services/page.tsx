          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-12 md:gap-16">
            ...
            <div className="border border-[var(--border-strong)] bg-[var(--ui-surface)] p-6 md:p-8">
              ...
              <Link
                ...
                className="ui-button min-h-[48px] w-full px-8 py-4 text-base font-semibold focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-[var(--text-primary)] sm:w-auto"
              >
                Start a project request
              </Link>
            </div>
